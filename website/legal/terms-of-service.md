...
You must be at least 13 years old to create an account and use collector-facing portions of the App or Website. By using the App or Website, you represent that you meet the applicable age requirements for the features you access.
...
- We may suspend or terminate accounts that violate these Terms or threaten the safety or integrity of the platform
...
Official Print payments are generally non-refundable except where required by law or where Ophinia expressly approves a refund because of verified damage, technical error, or fulfillment failure.
...
THE APP AND WEBSITE ARE PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT.
...
We may suspend, restrict, or terminate your access to the App or Website at any time, with or without notice, if we believe you have violated these Terms, created risk for the platform or other users, or if continued service is no longer commercially or operationally feasible.

---

## 17. Governing Law and Disputes

These Terms are governed by the laws of the State of Indiana, without regard to conflict-of-law principles. Any dispute arising out of or relating to these Terms, the App, or the Website shall be brought exclusively in the state or federal courts located in Indiana, and you consent to the jurisdiction of those courts.

---

## 18. Changes to These Terms

We may update these Terms from time to time. We will notify you of material changes by updating the "Last Updated" date and, where appropriate, through the App, the Website, or email. Continued use of the App or Website after the updated Terms take effect constitutes acceptance of the revised Terms.
