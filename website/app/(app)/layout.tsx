        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-6 py-4">
          <div className="flex items-center gap-6">
            ...
            <div className="hidden items-center gap-4 text-sm text-gray-600 md:flex">
              ...
              <Link href="/personalized-requests" prefetch={false} className="hover:text-black">Personalized Requests</Link>
              ...
              <Link href="/me/listings" prefetch={false} className="hover:text-black">My Listings</Link>
              <Link href="/me/offers" prefetch={false} className="hover:text-black">Offer Queue</Link>
              <Link href="/marketplace" prefetch={false} className="hover:text-black">Marketplace</Link>
            </div>
          </div>
          <div className="text-right">
            <div className="text-[11px] uppercase tracking-[0.22em] text-gray-500">Ophinia Account</div>
