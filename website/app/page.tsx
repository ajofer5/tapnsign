...
export default function HomePage() {
  return (
    <main>
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-1 bg-black/95 backdrop-blur-sm">
      ...
      <section className="bg-black py-24 px-6 text-center">
        <img src="/logo.png" alt="TapnSign" className="h-[7.5rem] mx-auto mb-3" />
      ...
      {/* Footer */}
      <footer className="bg-black border-t border-white/10 py-3 px-6">
