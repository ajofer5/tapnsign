...
- You may not create an account on behalf of another person without their authorization
...
- When you purchase an autograph, ownership is recorded on TapnSign's platform
- Ownership transfers are final once payment is completed
- TapnSign maintains the Certificate of Authenticity records as the authoritative source of ownership
- We are not responsible for transactions conducted outside of the App
...
- TapnSign charges a platform fee on autograph sales, which will be disclosed at the time of transaction
- Payments are final. Refunds are issued at our sole discretion and only in cases of technical error or fraud
- Official Print purchases are subject to the Print Product terms in Section 7

---

## 7. Print Product

TapnSign offers an official print ("Official Print") that allows the current owner of an autograph to order a physical 8×12 print fulfilled by our third-party print partner. The Official Print is priced at $16.99, shipping included.

### 7.1 One Print Per Owner

Each autograph owner may order one Official Print per autograph. This limit exists to protect the scarcity and authenticity of official TapnSign prints. Print records are permanently associated with the owner at the time of order and the autograph's Certificate of Authenticity.

### 7.2 Print Fulfillment

Official Prints are fulfilled by a third-party print vendor. TapnSign is not responsible for shipping delays, carrier errors, or print quality issues caused by the fulfillment vendor. Domestic (US) shipping only.

### 7.3 No Digital Download

Print files are not available for digital download. The Official Print entitles you to one physical 8×12 shipment only. Unauthorized reproduction of TapnSign prints is prohibited.

### 7.4 Damage Claims

If your print arrives damaged, you may submit a damage claim through the App. The claim process requires:

1. A photo of the front of the damaged print (showing the QR code)
2. A photo of the back of the damaged print (showing the print date and time)

TapnSign will review your submission. If the claim is approved, you will be asked to cut the damaged print in half and submit a photo of the front showing the QR code. This destruction step is required to confirm that only one physical print remains in circulation before a reprint is authorized.

Approved damage claims result in a reprint authorization. The original damaged print record is permanently voided. TapnSign reserves the right to deny damage claims that cannot be verified or that appear fraudulent.

### 7.5 Print Refunds

Official Print payments are non-refundable except in cases of verified shipping damage as described in Section 7.4. If your claim is approved, TapnSign will issue a full refund of the $16.99 print fee.
...
- Upload or transmit content that is defamatory, obscene, or infringes on any third-party intellectual property rights
...
- Sell, transfer, or sublicense your account to another person
- Engage in fraudulent transactions or manipulate pricing
- Capture and sell autographs of individuals without their consent
- Submit false or fraudulent print damage claims
- Reproduce, distribute, or sell TapnSign official prints without authorization
...
- **Print content:** Official TapnSign prints are licensed for personal display only. Commercial reproduction or resale of print files or physical prints is prohibited.
...
- Print orders will be fulfilled within any specific timeframe
...
IN NO EVENT SHALL OUR TOTAL LIABILITY TO YOU EXCEED THE GREATER OF (A) THE AMOUNT YOU PAID TO TAPNSIGN IN THE 12 MONTHS PRECEDING THE CLAIM OR (B) $100.
